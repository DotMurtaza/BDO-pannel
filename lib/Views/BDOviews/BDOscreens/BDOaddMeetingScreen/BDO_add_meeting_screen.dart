...
import 'Components/BDO_add_meeting_drop_down.dart';

class BDOaddMeetingPage extends StatefulWidget {
  const BDOaddMeetingPage({Key key, this.color, @required this.ismeeting});
...
class _BDOaddMeetingPageState extends State<BDOaddMeetingPage> {
  String clientId;
  String clientName;
  var dropdownvalue;
  DateTime pickedDate;
                      ...
                      BDOmyButton(
                          ...
                          onTap: () {
                            if (clientId == null) {
                              Get.defaultDialog(
                                  title: 'Alert',
                                  content: Text('Please select the client'),
                                  onConfirm: () {
                                    Get.back();
                                  },
                                  confirmTextColor: Colors.white);
                            } else if (showTime == "12:00 AM") {
                              Get.defaultDialog(
                                  title: 'Alert',
